...
const About = () => {
    ...
    return (
        <div className='about-area p-top-bottom-90'>
            <Container>
                <Row>
                    <Col md={12} lg={12} dangerouslySetInnerHTML={{ __html: homeContent?.acf?.about_professions }}>
                ...
                <Row>
                    <Col lg={6} md={12} className='about-img-wrap'>
                    ...
                    <Col lg={6} md={12} className='about-text'>
                        ...
                        <Button type='primary'>{homeContent?.acf?.about_button}</Button>
                    </Col>
                </Row>
            </Container>
        </div>
